Day 23 - Advent of Code 2022window.addEventListener('click', function(e,s,r){if(e.target.nodeName==='CODE'&&e.detail===3){s=window.getSelection();s.removeAllRanges();r=document.createRange();r.selectNodeContents(e.target);s.addRange(r);}});
...
[Sentry.io](https://sentry.io/) - More than 3.5 million developers across 85,000 organizations ship better software, faster, with Sentry. What are you waiting for?
