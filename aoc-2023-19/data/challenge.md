Day 19 - Advent of Code 2023window.addEventListener('click', function(e,s,r){if(e.target.nodeName==='CODE'&&e.detail===3){s=window.getSelection();s.removeAllRanges();r=document.createRange();r.selectNodeContents(e.target);s.addRange(r);}});
...
Peter Tillemans [(AoC++)](/2023/support) 36\*
...
[Konfuzio AI](https://konfuzio.com/en/adventofcode/) - Dad-Joke-Theorem: How challenging can jokes be?
